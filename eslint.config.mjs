...
const eslintConfig = defineConfig([
  ...
  ]),
  {
    ...
    // стоял ниже возврата из функции и не выполнялся никогда, а правило
    // отключено в базовом конфиге Next. Аудит 2026-08-16 нашёл ту же ошибку
    // ВТОРОЙ раз — потому что правило было заперто в блоке tsx-файлов и на
    // src/lib не действовало. Область теперь — ВЕСЬ исходник и скрипты.
