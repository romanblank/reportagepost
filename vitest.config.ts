...
export default defineConfig({
  ...
  test: {
    ...
    // Жёстко уводим хранилище в локальный тестовый каталог ДО импорта модулей
    // (аудит 2026-08-01, P2: иначе тесты пишут в боевой бакет, если в .env
    // оказались прод-ключи).
