 ...
 * подтверждения фотографа. Односторонняя отметка была self-attested: при
 * открытой регистрации (инвайт-гейт УДАЛЁН 2026-08-10) автор мог бы завести
 * фейковых «заказчиков» и накрутить себе verified-отзывы. Двусторонность +
 * trust-контур (needsReview, viaInvite, капы, кластеры ipHash) — действующая
 * защита этого сигнала.
 */
