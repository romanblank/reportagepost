...
/**
 * Фора на заявку ВЫКЛЮЧЕНА решением партнёра (2026-08-18): «усложняет и
 * сильно увеличивает неравенство… имидж компании, стремящейся к наживе».
 * Нули означают: заявка видна и рассылается ВСЕМ одновременно, независимо
 * от подписки. Механизм волн (releaseInquiries) оставлен живым — вернуть
 * перк можно правкой этих констант, код и тесты переживут оба режима.
 */
