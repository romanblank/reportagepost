...
export const ru = {
  ...
  landing: {
    ...
    cityAuthorsKicker: 'Каталог',
    cityAuthorsMore: 'Весь каталог →',
    trustSectionKicker: 'Как устроено доверие',
    trustSectionTitle: 'Доверие держится на подтверждённых съёмках',
    trustSectionLead: 'Мы не выставляем авторам оценки. Вместо звёзд — факты: заказчик отмечает состоявшуюся съёмку, автор её подтверждает, и только тогда она попадает на страницу.',
    trustPoint1Title: 'Съёмку подтверждают двое',
    trustPoint1Text: 'Отметка заказчика становится публичной, только когда автор её подтвердил. В одиночку накрутить нельзя.',
    trustPoint2Title: 'Отзыв — за работу, не за переписку',
    trustPoint2Text: 'Признак «снимали вместе» получают отзывы тех, у кого действительно была съёмка.',
    trustPoint3Title: 'Порядок в каталоге не покупается',
    trustPoint3Text: 'Подписка добавляет видимость и инструменты, но не двигает выдачу: место наверху всегда за работами.',
