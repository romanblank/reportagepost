...
export const ru = {
  ...
  landing: {
    ...
    loginCta: 'Войти',
    forPhotographers: 'Фотографам',
    forPhotographersText: 'Страница с вашими работами, находки редакции и заявки по городу и жанру — вместо разрозненных соцсетей и сарафана.',
    forClients: 'Заказчикам',
    ...
    step2Title: 'Редакция смотрит работы',
    step2Text: 'Каждую страницу смотрит редакция — так каталог остаётся про репортаж, а не про всё подряд.',
    step3Title: 'Получайте заявки',
    step3Text: 'Заказчики находят вас по городу и жанру, пишут напрямую. Без комиссии платформы.',
    // Отстройка
    whyTitle: 'Только репортаж',
    whyText: 'В соцсетях работы тонут в ленте. На бирже автор — в ряду с сантехником. Здесь только событийная съёмка: живые отклики заказчиков и находки редакции вместо случайных оценок.',
  },
  catalog: {
