...
export const ru = {
  ...
  portfolio: {
    title: 'Портфолио',
    lead: 'Управляйте своими работами: порядок, обложка каталога, удаление.',
    locked: 'Управление станет доступно после одобрения профиля.',
    empty: 'В портфолио пока нет фото. Добавьте работы в анкете.',
    ...
    coverOnlyApproved: 'Обложкой можно сделать только опубликованное фото.',
    moveUp: 'Выше',
    moveDown: 'Ниже',
    delete: 'Удалить',
    deleteConfirm: 'Удалить это фото? Действие необратимо.',
