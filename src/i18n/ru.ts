...
export const ru = {
  ...
  cabinet: {
    ...
    proTitle: 'Тариф',
    proOnFree: 'Вы на тарифе Базовый',
    proOnPro: 'У вас PRO',
    proFounding: 'Основатель — цена закреплена навсегда',
    proGraceUntil: (d: string) => `Бесплатный PRO беты — до ${d}`,
    proLockedLead: 'На PRO открывается:',
    proRequestCta: 'Запросить подключение PRO',
    proRequesting: 'Отправляем…',
    proRequested: 'Заявка отправлена — оператор подключит PRO в ближайшее время',
