...
export const ru = {
  ...
  landing: {
    ...
    heroLead: 'Портфолио, признание цеха и прямые заявки на съёмку событий: конференции, концерты, спорт, корпоративы, частные праздники. Заказчики находят — фотографы получают работу.',
