...
export const ru = {
  ...
  pro: {
    ...
    title: 'Больше заказов там, где вас ищут',
    lead: 'PRO поднимает вашу страницу в каталоге и поиске, снимает лимиты портфолио и открывает участие в «Признании». Бесплатный тариф остаётся навсегда.',
    planFree: 'Базовый',
    planPro: 'PRO',
    free: 'Бесплатно',
    perMonth: 'в месяц',
    perYear: 'в год',
    annualEquiv: (s: string) => `≈ ${s} в месяц при оплате за год`,
    ...
    betaNote: 'В закрытой бете подключение оплаты (Т-Касса) ещё активируется — первым авторам PRO подключает оператор вручную. Публичная оплата откроется к запуску.',
    features: {
      ...
      recognition: 'Бейдж PRO и участие в рейтинге «Признание»',
